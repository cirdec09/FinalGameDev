...
var level2State = function(game){
  ...
  left = false, right = false, up = false, down = false;
    ...
    //BackgroundImage
        ...
        //pause
        pausebtn = game.add.button(540,15,"pause",this.handlepause);
        ...
        player.animations.add('pataas',[0,1,2,3],7,true);
        player.animations.add('pababa',[8,9,10,11],7,true);
        ...
        enemy1.body.velocity.setTo(-230, 230);
        ...
        enemys.body.velocity.setTo(-230, 230);
        ...
        enemyss.body.velocity.setTo(-230, 230);
        enemyss.body.bounce.set(1);
        enemyss.scale.x = 2;
        enemyss.scale.y = 2;

        enemysss = game.add.sprite(300,400,"enemysss");
        ...
        enemysss.body.velocity.setTo(-230, 230);
        enemysss.body.bounce.set(1);
        enemysss.scale.x = 2;
        enemysss.scale.y = 2;

        // //kaliwa
        kaliwa = game.add.button(15,505,"kaliwa",null,this,0,0);
        kaliwa.scale.x = 1.2;
        kaliwa.scale.y = 1.5;
        kaliwa.inputEnabled = true;
        ...
        //KananButton
        kanan = game.add.button(75,505,'kanan',null,this,0,0);
        kanan.scale.x = 1.2;
        kanan.scale.y = 1.5;
        kanan.inputEnabled = true;
        ...
        //pataas
        up = game.add.button(55,450,'up',null,this,0,0);
        up.scale.x = 1.1;
        up.scale.y = 1.5;
        ...
        //down
        down = game.add.button(55,535,'down',null,this,0,0);
        down.scale.x = 1.1;
        down.scale.y = 1.5;
        ...
        down.events.onInputUp.add(function(){up=false;});

        this.timer(1000,duration);
        
        //Text
        gameOverText = game.add.text(300,260,"Game Over !",{font:'90px Arial',fill:'red'});
        ...
        level2 = game.add.text(350,15,"Level 2",{fill:"yellow"});
  ...
  update: function(){
    ...
    //4
    game.physics.arcade.collide(border1,enemysss);
    game.physics.arcade.collide(border2,enemysss);
    game.physics.arcade.collide(border3,enemysss);
    game.physics.arcade.collide(border4,enemysss);
    ...
    //MobileTouch
        ...
        if(game.physics.arcade.collide(player,enemy1)){
            ...
            game.add.button(300,400,"playG",this.playAG);
            kansyon.stop();
            natay.play();
            player.kill();
            // game._paused = true;
